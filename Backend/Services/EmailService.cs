    ...
    public class EmailService
    {
        ...
        public async Task SendEmail(string subject, string to, string body)
        {
            ...
            using (SmtpClient client = new SmtpClient(_smtpServer, _smtpPort))
            {
                ...
                try
                {
                    await client.SendMailAsync(message); // Changed to SendMailAsync
                }
        ...
        public async Task SendEmailConfirmation(string to, string code)
        {
            ...
            await SendEmail(subject, to, body); // Now you can await it
        }
    }
}
